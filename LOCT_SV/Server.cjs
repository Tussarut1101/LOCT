...
const serverLogin = require("../LOCT_SV/Login/Login.cjs");
const serverCommon = require("../LOCT_SV/Common/Common.cjs");
const serverTransaction = require("../LOCT_SV/Transaction/Transaction.cjs");
const serverReportSummary = require("../LOCT_SV/Report/SummaryRPT.cjs");
const serverReportDetail = require("../LOCT_SV/Report/DetailRPT.cjs");
